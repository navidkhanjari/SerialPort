...
*  supported by Asmedia 104x USB3 Host Controller Drive.
*
************************************************************
************************************************************
...
The Asmedia 104x USB3 Host Controller Drive is designed to provide 
...
1. Install from setup program
   ...
   install the Asmedia ASM104x USB 3.0 Host controller driver
...
1. Select 'Uninstall' from the following steps:
		...
		- Find "Asmedia ASM104x USB3.0 Host Controller Driver",
